...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public void __Gen_Delegate_Imp1(LuaCore_PlayerInfo p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp3(out int p0, out float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                p0 = LuaAPI.xlua_tointeger(L, errFunc + 2);
                p1 = (float)LuaAPI.lua_tonumber(L, errFunc + 3);
		...
		public void __Gen_Delegate_Imp4(XLua.LuaTable p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp5(LuaCore p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(LuaCore p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp28(XLuaTest.StructTest p0, int p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp29(XLuaTest.StructTest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp30(XLuaTest.StructTest p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(MoveControl))
			{
			    return new MoveControl(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(MyTransSelfAndParams_PlayerInfo))
			{
			    return new MyTransSelfAndParams_PlayerInfo(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(Func22))
			{
			    return new Func22(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(Func4))
			{
			    return new Func4(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(TransSelfAndParams))
			{
			    return new TransSelfAndParams(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(MyTransSelf))
			{
			    return new MyTransSelf(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(MyTransSelfAndParams))
			{
			    return new MyTransSelfAndParams(__Gen_Delegate_Imp6);
			}
